...
for id,a,b,question in [
 ...
 jobs.append(dict(audio=str(r/'stems'/(id+'_vocals.wav')),start=a,end=b,normalize=True,prompt=question+' Do not guess if unclear.',output=str(r/'second_pass'/(asset_stem(id)+'_vocals.json'))))
